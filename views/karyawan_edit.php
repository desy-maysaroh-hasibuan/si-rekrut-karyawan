                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="date" name="tgl_masuk" value="<?=$data['tgl_masuk']?>" class="form-control" id="inputEmail3" placeholder="Inputkan Tgl Masuk" required>
                            </div>
                        </div>
...
if($_POST){
    ...
    //buat sql
    $sql="UPDATE tb_karyawan SET nama='$nama',alamat='$alamat',tgl_lahir='$tgllahir',no_telp='$notelp',p_terakhir='$pterakhir',tgl_masuk='$tglmasuk' WHERE id ='$id'"; 
